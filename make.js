...
async function processPages(files) {
  ...
  const resources = ["styles.css", "favicon.png", "github.svg", "robots.txt"];
...
task("website", [], async () => {
  ...
  const files = [
    ...
    "business/the score takes care of itself - bill walsh.md",
    ...
    "relationships/how to talk so kids will listen - adele faber.md",
