...
* The basics (chap 1)
  ...
  * It's easy to see the elements of a system. It's harder to see and understand the
...
* System traps... and opportunities (chap 5)
  ...
  * Tragedy of the commons
    * "In any commons system there is, first of all, a resource that is commonly shared (the
      pasture). For the system to be subject to tragedy, the resource must not only be limited, but
      erodable when overused."
    ...
    * "Every user benefits directly from its use, but shares the costs of its abuse with everyone
      else. Therefore, there is very weak feedback from the condition of the resource to the
      decisions of the resource users. The consequence is overuse of the resource, eroding it until
    ...
    * How to avoid the tragedy of the commons
      ...
      * Privatize the commons. "Divide it up, so that each person reaps the consequences of his or
        her own actions." Although many resources, like the air and the fish in the sea, cannot be
        privatized.
  ...
  * Drift to low performance
    ...
    * E.g. on a losing sports team, set the standard/goal for the system using the best performances
      of the past, not the current (poor) performance, which introduces a positive mindset and
      pull-up effect.
  * Escalation
  ...
  * Success to the successful: competitive exclusion
    ...
    * A way out is "periodically 'leveling the playing field.' Traditional societies and game
      designers instinctively design into their systems some way of equalizing advantages, so the
  ...
  * Shifting the burden to the intervenor -- addiction
    ...
    * "The trap is formed if the intervention, whether by active destruction of simple neglect,
      undermines the original capacity of the system to maintain itself. If that capability
      atrophies, then more of the intervention is needed to achieve the desired effect."
    ...
    * "The individual or community that is being helped may not think through the long-term loss of
      control and the increased vulnerability that go along with the opportunity to shift a burden
      to an able and powerful intervenor."
  ...
  * Impactful levers, in ascending order of leverage
    ...
    * Stock and flow structures: the plumbing between stocks. Obviously impactful, if it can
      ...
      * "Physical structure is crucial in a system, but is rarely a leverage point, because changing
        it is rarely quick or simple. The leverage point is in proper design in the first place.
    ...
    * Reinforcing feedback loops: the strength of the gain of driving loops
      * "A reinforcing feedback loop is self-reinforcing. The more it works, the more it gains power
        to work some more."
      * It must be eventually checked by a balancing feedback loop or the system will destroy
        itself.
    ...
    * Goals -- the purpose or function of the system
      * "Changing the players in the system is a low-level intervention, as long as the players fit
        into the same old system. The exception to that rule is at the top, where a single player
    ...
    * Transcending paradigms
      * Meaning "to keep oneself unattached in the area of paradigms, to stay flexible, to realize
        ...
        worldview, is a tremendously limited understanding of an immense and amazing universe that
