...
* As a leader: "always take a chance on better, even if it seems threatening." E.g. hiring people
  who are smarter or more ambitious than you, to make your team perform well.
* Toy Story 2 retrospective: "Get the team right!"
  * "If you give a good idea to a mediocre team, they will screw it up. If you give a mediocre idea
    to a brilliant team, they will either fix it or throw it away and come up with something
    better."
...
* "If you aren't experiencing failure, then you are making a far worse mistake: you are being driven
...
* Notes day: An epic, all day session where everyone in the company discusses their ideas for how to
  make the company better, with a focused theme (e.g. "3 movies in 2 years") for the breakout
  sessions. Cathartic. Encourages candor, ownership, and a long-term view of and participation in
  the company.

## Intro

* Pixar's campus: "The unifying idea... isn't luxury but community. Steve wanted the building to
  support our work by enhancing our ability to collaborate." It should convey "self-expression,
  palpable energy; air of possibility."
...
* Ed's lifelong dream was to animate a feature film. It took him 20 years to do that. Once Toy Story
...
* "As I turned my attention from solving technical problems to engaging with the philosophy of sound
  management, I was excited once again -- and sure that our second act could be as exhilarating as
  our first."
  * (He didn't want his company to fall apart like other public or well-funded tech companies he'd
    seen who did so despite having brilliant founders.)

## Animated (chap 1)

* His graduate professor was Ivan Sutherland, author of Sketchpad. University of Utah was one of the
...
* Ed builds a graphics group in New York, moves everyone to Lucasfilm, and then the group is sold to
  Steve Jobs.
* As a leader: "always take a chance on better, even if it seems threatening." E.g. hiring people
  who are smarter or more ambitious than you, to make your team perform well.
...
* "Building a company was like being on a wagon train headed west. On the long journey to the land
  of plenty, the pioneers would be full of purpose and united by the goal of reaching their
  destination. Once they arrived... people would come and go, and that was as it should be. But the
  process of moving *toward* something -- of having not yet arrived -- was what he idealized."
* "This was my first encounter with a phenomenon I would notice again and again, throughout my
  career: for all the care you put into artistry, visual polish frequently doesn't matter if you are
  getting the story right."
* George Lucas separated with his wife and needed to sell Pixar to regain cash. No buyers were
  interested, because commercial applications will take another $15M to develop.
* Steve Jobs originally desired that Pixar serve as the foundation of NeXT. He bought 70% of Pixar's
  stock for $10M. 30% went to the employees.

## A defining goal (chap 3)

* After Toy Story 1, the goal became: build a creative culture that would endure past the founders
...
* (Deming's Japanese lean manufacturing techniques had a profound impact on Ed. "Everyone should be
  empowered to take responsibility for the quality of the product.")
* Pixar could not make hardware sales work, and so they pivoted one last time to entirely animation.
* 1991: laid off one third of employees.
* Steve tried to sell the company three times. The offers weren't bad -- $40M from Microsoft. Steve
  was using these for external validation, to build confidence to keep going.
* Huge breakthrough: 1991 they cut a deal with Disney to make three feature length films. Disney
  wanted more output after their success with Little Mermaid, Aladdin, Beauty and the Beast, and
  Lion King.
* Two big 1991 blockbusters -- Beauty and the Beast and Terminator 2 -- used Pixar's tech, and
  Hollywood was noticing.
* "John once described Steve's story as the classic Hero's Journey. Banished for his hubris from the
  company he founded, he wandered through the wilderness having a series of adventures that, in the
  end, changed him for the better. I have much to say about Steve's transformation and the role
  Pixar played in it, but for now, I will simply assert that failure made him better, wiser, and
  kinder."
* As they felt good about Toy Story's imminent release, Steve scrambled to take them public so they
  could renegotiate their contract with Disney. (Great foresight and hustle! They went public in
  1995).
* How to understand a problem once spotted? Attention, and lots of conversations.
  * (It doesn't sound difficult, but I find it hard to avoid jumping straight to a solution, because
    I'm impatient or feel short on time)
...
* The initial junior team working on Toy Story 2 failed. Lasseter stepped in and took over. Ed asked
  himself: how did that happen?
* They managed to build a high quality sequel on a frantic 9 month schedule, under pressure from
  Disney to make it direct-to-video.
  * "As Lee Unkrich says, 'We had done the impossible. We had done the thing that everyone told us we
    couldn't do. And we had done it spectacularly well. It was the fuel that has continued to burn in
    all of us.'"
* Toy Story 2 retrospective: "Get the team right!"
  * "If you give a good idea to a mediocre team, they will screw it up. If you give a mediocre idea
    to a brilliant team, they will either fix it or throw it away and come up with something
...
* Product research versus the development and scaling phase:
  * In the research phase, the only costs are the salaries of the director and story artists. The
    goal is to do as much work and iteration in the research phase as possible; spend years if
    needed. In production is where costs explode.
...
* "Part of our job is to protect the new from people who don't understand that in order for
  ...
  * "Protect the new" to make sure unusual immature ideas have their chance to mature and prove
    themselves.
* Balancing group size: larger teams means more/ better work, but less intimate meetings and smaller
  scope. Refactoring into smaller teams can help with that.
...
* Creativity in isolation doesn't work. "I know some people who like to keep their gem completely to
  themselves while they polish it. But allowing this kind of behavior isn't productive. In fact, it
  can be the opposite: a failure to protect your employees from themselves. Because if history is
  any guide, some are diligently trying to polish a brick."
...
* "One trick I've learned is to force myself to make a list of what's actually wrong... I find I can
  group most of the issues into two or three larger all-encompassing problems. So it's really not
  all that bad. Having a finite list of problems is much better than having an illogical feeling
  that *everything* is wrong."
* "I believe life should not be easy. We're meant to push ourselves and try new things -- which will
  definitely make us feel uncomfortable. Living through a few big catastrophes helps. After people
  survived A Bug's Life and Toy Story 2, they realized the pressure led to some pretty cool ideas."
  * He's skeptical of film pitches which have all the pieces hanging together from the outset.
...
* Constraints
  ...
  * But don't do this too early, in the discovery phase, because that can limit creativity and
    exploration.
* Postmortems
  * They're held right after shipping every major movie.
  * Organize the lessons learned, for the rest of the company and for producing better films.
  * It gives team members a release valve to productively vent frustrations.
  * Data they collect to fuel their postmortems:
    ...
    * "I like data because it is neutral -- there are no value judgments, only facts. That allows
      ...
      experience."
* Pixar University is mainly about sending the cultural signal that people should always be learning
  and exploring.

## The unmade future (chap 11)

* This chapter is a tour of various mental models or "coping mechanisms" used by people at Pixar to
  drive into the creative unknown and endure the uncertainty. Also, mental models for thinking about
  how to get people to an unknown destination.
...
* The creative process is a long dark tunnel. In the middle is dark and uncertain, but if you assume
...
* Pre-acquisition, to assuage employee fears they drafted a seven page list of comp and cultural
  items that wouldn't change for five years. "We were different, and since we believe being
  different helps us maintain our identity, we wanted to remain that way."
* They wanted to keep both studios (Pixar, Disney Animation) entirely separate. (He didn't elaborate
  on why)
* The feedback system at Disney had mandatory changes which came from non-filmmakers. They abolished
...
* An epic, all day session where everyone in the company discusses their ideas for how to make the
  ...
  Cathartic. Encourages candor, ownership, and a long-term view of and participation in the company.
