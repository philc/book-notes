...
* Place your bets (chap 8)
  ...
  * R&D mode
    ...
    * Jason, David, and a senior designer spent a year exploring HEY and settling the core. Then another year
      to productionize it.
  ...
  * Cleanup mode
    ...
    * Considering making some cuts in the cleanup phase to reduce some of the post-launch support burden.
